...
struct usb_proc_disconnectsignal {
	unsigned int signr;
	void *context;
};

#define USB_PROC_URB_DISABLE_SPD           1
#define USB_PROC_URB_ISO_ASAP              2

#define USB_PROC_URB_TYPE_ISO		   0
#define USB_PROC_URB_TYPE_INTERRUPT	   1
#define USB_PROC_URB_TYPE_CONTROL	   2
#define USB_PROC_URB_TYPE_BULK		   3

struct usb_proc_iso_packet_desc {
	unsigned int length;
...
struct usb_proc_urb {
	...
	void *usercontext;
	struct usb_proc_iso_packet_desc iso_frame_desc[0];
};
...
#define USB_PROC_SUBMITURB         _IOR('U', 10, struct usb_proc_urb)
#define USB_PROC_DISCARDURB        _IO('U', 11)
#define USB_PROC_REAPURB           _IOW('U', 12, void *)
#define USB_PROC_REAPURBNDELAY     _IOW('U', 13, void *)
#define USB_PROC_DISCSIGNAL        _IOR('U', 14, struct usb_proc_disconnectsignal)



#ifdef __KERNEL__

#include "usbdevicefs/usbdevice_fs.h"
...
struct usb_device {
	...
	/* usb device filesystem state */
	struct usbdevicefs_devstate devfs;
